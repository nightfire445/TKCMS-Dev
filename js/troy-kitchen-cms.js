...
function populateInfo(event, vendor_data) {
  ...
  for(var i = 0; i < images.length; i++) {
    ...
    image_string += "<button type='button' class='btn btn-danger delete-img' onclick='$.post( \"dashboard.php\", { delete_image: \"\", image_url: \"" + images[i].image_url + "\" } ); '>Delete</button></div>";
  }
